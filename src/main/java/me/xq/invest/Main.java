...
import me.xq.invest.service.impl.*;
...
public class Main {
    public static void main(String[] args) {
        ...
        XqFinanceDownloadServiceImpl xqFinanceDownloadService = (XqFinanceDownloadServiceImpl) context.getBean("xqFinanceDownloadService");
        XqDebtServiceImpl xqDebtService = (XqDebtServiceImpl) context.getBean("xqDebtService");
        XqCashFlowServiceImpl xqCashFlowService = (XqCashFlowServiceImpl) context.getBean("xqCashFlowService");
        XqKlineServiceImpl xqKlineService = (XqKlineServiceImpl) context.getBean("xqKlineService");
        //存放下载错误的股票代码
            ...
            for (String xqIdString : xqIdList) {
                ...
                try {
                   ...
                   // xqInfoDownloadService.xqDownload(XqInfo.class, xqIdString, "http://d.10jqka.com.cn/v2/line/hs_%s/01/last.js", new String[]{xqIdString});
                    // xqFinanceDownloadService.xqDownload(xqIdString, "http://stockpage.10jqka.com.cn/basic/%s/main.txt", new String[]{xqIdString});
                    //xqDebtService.downloadXqDebt(xqIdString, "http://stockpage.10jqka.com.cn/basic/%s/debt.txt", new String[]{xqIdString});
                    //xqCashFlowService.downloadXqCashFlow(xqIdString, "http://stockpage.10jqka.com.cn/basic/%s/cash.txt", new String[]{xqIdString});
                    xqKlineService.downloadXqKlineToday(xqIdString, "http://d.10jqka.com.cn/v2/line/hs_600177/01/today.js", new String[]{xqIdString});
